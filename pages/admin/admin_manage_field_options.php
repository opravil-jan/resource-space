    ...
    if(isset($new_record_ref) && !(trim($new_record_ref)==""))
        ...
        if(7 != $field_data['type'] && (trim($new_option_parent)==""))
            ...
            <tr id="node_<?php echo $new_record_ref; ?>">
                <td>
                    <input type="text" name="option_name" form="option_<?php echo $new_record_ref; ?>" value="<?php echo $new_option_name; ?>">
                </td>
                <td>
                    <div class="ListTools">
    ...
    <div class="ListView">
        ...
        foreach(get_nodes($field) as $node)
            ...
            <tr id="node_<?php echo $node['ref']; ?>">
                <td>
                    <input type="text" name="option_name" form="option_<?php echo $node['ref']; ?>" value="<?php echo $node['name']; ?>">
                </td>
                <td>
                    <div class="ListTools">
