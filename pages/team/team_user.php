...
for ($n=$offset;(($n<count($users)) && ($n<($offset+$per_page)));$n++)
	...
	<a href="<?php echo $baseurl ?>/pages/team/team_system_log.php?actasuser=<?php echo $users[$n]["ref"]?>&backurl=<?php echo urlencode($url . "&offset=" . $offset)?>" onClick="return CentralSpaceLoad(this,true);">&gt;&nbsp;<?php echo $lang["log"]?></a>
	&nbsp;
