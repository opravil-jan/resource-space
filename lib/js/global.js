...
function ModalCentre()
	{
	// Centre the modal and overlay on the screen. Called when opened and also when the browser is resized.
	
	jQuery('#modal_overlay').css({height: jQuery('.ui-layout-center').height()});
	...
	height:jQuery('.ui-layout-center').height() - 120
	});
	}
function ModalClose()
	{
